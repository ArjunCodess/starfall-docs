...
|------------|-----------|
| '/' page![Light1](/light1.png) | '/' page![Dark1](/dark1.png) |
| '/dashboard' page![Light2](/light2.png) | '/dashboard' page![Dark2](/dark2.png) |
| '/admin' page![Light3](/light3.png) | '/admin' page![Dark3](/dark3.png) |
| '/admin' page![Light4](/light4.png) | '/admin' page![Dark4](/dark4.png) |